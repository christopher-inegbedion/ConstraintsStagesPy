...
EXCESSIVE_CONFIGURATION_INPUTS_ENTERED = "Excessive configuration inputs entered. "
INSUFFICIENT_CONFIGURATION_INPUTS_ENTERED = "Insufficient configuration inputs entered. "
